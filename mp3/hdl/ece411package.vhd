...
-- DATAPATH SIGNAL WIDTHS
	...
	SUBTYPE LC3B_LRULINE   IS STD_LOGIC_VECTOR(23 DOWNTO 0);
...
--CACHE SIGNALS (ADD MORE TO ME!!)
  ...
  SUBTYPE LC3B_L2_INDEX  IS STD_LOGIC_VECTOR(1 DOWNTO 0);
  SUBTYPE LC3B_L2_TAG    IS STD_LOGIC_VECTOR(9 DOWNTO 0);
	...
	CONSTANT ALU_SRL  : LC3B_ALUOP := "101";
	CONSTANT ALU_SRA  : LC3B_ALUOP := "110";
	CONSTANT ALU_ADDX : LC3B_ALUOP := "111";
