echo "--- Executing initialization force file for ../testcode/BRprediction3.asm ---"
...
echo "Done initializing processor, loading ../testcode/BRprediction3.asm program code."
run 5
...
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(3) X"F0"
...
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(12) X"16"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(13) X"00"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(14) X"A1"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(15) X"14"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(16) X"E1"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(17) X"16"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(18) X"21"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(19) X"19"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(20) X"61"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(21) X"1B"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(22) X"63"
...
run 5
echo "Done loading ../testcode/BRprediction3.asm program code."
