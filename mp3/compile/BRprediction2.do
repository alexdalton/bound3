echo "--- Executing initialization force file for ../testcode/BRprediction2.asm ---"
...
echo "Done initializing processor, loading ../testcode/BRprediction2.asm program code."
run 5
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(0) X"05"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(1) X"E2"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(2) X"40"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(3) X"C0"
...
run 5
echo "Done loading ../testcode/BRprediction2.asm program code."
