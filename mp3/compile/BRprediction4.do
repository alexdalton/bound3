echo "--- Executing initialization force file for ../testcode/BRprediction4.asm ---"
...
echo "Done initializing processor, loading ../testcode/BRprediction4.asm program code."
run 5
...
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(3) X"04"
...
run 5
echo "Done loading ../testcode/BRprediction4.asm program code."
