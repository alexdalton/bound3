echo "--- Executing initialization force file for ../testcode/BTBlooptest.asm ---"
...
echo "Done initializing processor, loading ../testcode/BTBlooptest.asm program code."
run 5
...
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(5) X"03"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(6) X"FF"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(7) X"0F"
run 5
echo "Done loading ../testcode/BTBlooptest.asm program code."
