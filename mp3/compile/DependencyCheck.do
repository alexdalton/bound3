echo "--- Executing initialization force file for ../testcode/DependencyCheck.asm ---"
...
echo "Done initializing processor, loading ../testcode/DependencyCheck.asm program code."
run 5
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(0) X"08"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(1) X"62"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(2) X"09"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(3) X"64"
change /mp3_CPU/aMEMORY/PMEM/vhdl_memory/mem(4) X"0A"
...
run 5
echo "Done loading ../testcode/DependencyCheck.asm program code."
