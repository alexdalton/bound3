echo "--- Executing initialization force file for ../testcode/mp3-test1.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp3-test1.asm program code."
run 5
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(0) X"02"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(1) X"0E"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(2) X"06"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(3) X"02"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(4) X"0B"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(5) X"02"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(6) X"62"
...
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(15) X"C0"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(16) X"62"
...
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(25) X"48"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(26) X"40"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(27) X"40"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(28) X"FF"
change /mp3_cpu/aMemory/PMEM/vhdl_memory/mem(29) X"0F"
run 5
echo "Done loading ../testcode/mp3-test1.asm program code."
