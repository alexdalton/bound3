...
#DEFAULT_MEMPATHS="/mp2_cpu/dram/pdram/vhdl_memory"
#DEFAULT_MEMPATHS="/mp3_CPU/DRAM16_DP/vhdl_memory"
DEFAULT_MEMPATHS="/mp3_CPU/aMEMORY/PMEM/vhdl_memory"
DEFAULT_COMPILEPATH="$HOME/ece411/bound3/mp3/compile"
